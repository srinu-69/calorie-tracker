...
def HomePageView(request):
	...
	if calorie_goal==0:
		calorie_consumed_percentage= (calories.total_calorie*100)/1;
	else:
		calorie_consumed_percentage= (calories.total_calorie*100)/calorie_goal;
	red=0
	if calorie_consumed_percentage>100:
		red=1
		calorie_consumed_percentage=calorie_consumed_percentage%100
	...
	'calorie_consumed_percentage':calorie_consumed_percentage,
	'red':red,
	'form':form,
